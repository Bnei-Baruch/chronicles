...
(
    ...
    user_id    VARCHAR(255)  NOT NULL, -- Keyclock
    ...
    namespace  VARCHAR(64)   NOT NULL, -- Client namespace, nested, e.g., "archive_v1.2.3.search"
		...
		client_event_type VARCHAR(16) NOT NULL, -- Click, keypress, play, stop, ...
		...
		client_flow_type  VARCHAR(16) NULL,		  -- Type for group of events such as "search", "page visit", "watch content"
